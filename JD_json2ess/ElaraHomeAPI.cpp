...
{
	reinterpret_cast<EssExporter*>(ctx)->AddBackground(sky, true);
}
...
void EH_set_sun_with_matrix(EH_Context *ctx, const EH_Sun *sun, float *mat)
{
	if (mat)
	{
		eiMatrix m = ei_matrix(mat[0], mat[1], mat[2], mat[3], mat[4], mat[5], mat[6], mat[7], mat[8], 
